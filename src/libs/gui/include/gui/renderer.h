...
namespace crl {
    namespace gui {
        inline void drawSphere(const P3D &p, double r, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            static Model sphere = Model(DATA_FOLDER "/meshes/sphere.obj");
            sphere.position = p;
         ...
         */
        inline void drawEllipsoid(const P3D &p, const Quaternion &orientation, const V3D &dims, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            static Model sphere = Model(DATA_FOLDER "/meshes/sphere.obj");
            sphere.position = p;
        ...
        inline void drawCuboid(const P3D &p, const Quaternion &orientation, const V3D &dims, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            static Model cube = Model(DATA_FOLDER "/meshes/cube.obj");
            cube.position = p;
        ...
        inline void drawWireFrameCuboid(const P3D &p, const Quaternion &orientation, const V3D &dims, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            static Model cube = Model(DATA_FOLDER "/meshes/cube_frame.obj");
            cube.position = p;
            cube.orientation = orientation;
            cube.scale = dims;
            cube.draw(shader, color, alpha);
        ...
        inline void drawCylinder(const P3D &startPosition, const P3D &endPosition, const double &radius, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            static Model cylinder = Model(DATA_FOLDER "/meshes/cylinder.obj");
        ...
        inline void drawCylinder(const P3D &startPosition, const V3D &direction, const double &radius, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            drawCylinder(startPosition, startPosition + direction, radius, shader, color, alpha);
        }

        inline void drawCone(const P3D &origin, const V3D &direction, const double &radius, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            static Model cone = Model(DATA_FOLDER "/meshes/cone.obj");
        ...
        inline void drawArrow3d(const P3D &origin, const V3D &direction, const double &radius, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            V3D dir = direction;
            for (uint i = 0; i < 3; i++) {
                if (fabs(dir[i]) < 1e-6) {
                    dir[i] = 1e-6;
        ...
        inline void drawCapsule(const P3D &sP, const P3D &eP, const double &radius, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
        ...
        inline void drawCapsule(const P3D &startPosition, const V3D &direction, const double &radius, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            drawCapsule(startPosition, P3D(startPosition + direction), radius, shader, color, alpha);
        }

        inline void drawCircle(const P3D &center, const V3D &normal, const double &radius, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            // Compute start and end position
            double height = 1e-3;
            drawCylinder(center, center + (normal.normalized() * height), radius, shader, color, alpha);
        }

        inline void drawRectangle(const P3D &p, const V3D &normal, const double &angle, const Vector2d &dims, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            V3D dim;
            dim[0] = dims[0];
            dim[1] = 1e-3;
            dim[2] = dims[1];
        ...
        inline void drawSector(const P3D &p, const V3D &from, const V3D &to, const V3D &up, const Shader &shader, const V3D &color = V3D(1, 0, 0), float alpha = 1.0) {
            static Model sector(DATA_FOLDER "/meshes/sector.obj");
        ...
        class SimpleGroundModel {
            public:
                ...
                Model grid1 = Model(DATA_FOLDER "/meshes/grid1.obj");
                Model grid2 = Model(DATA_FOLDER "/meshes/grid2.obj");
