...
namespace crl {
    namespace gui {
        class Model {
            public:
                std::vector<Mesh::TextureMap> material_textures;  // stores all the textures loaded so far,
                ...
                void draw(const Shader &shader, const V3D &color, const glm::mat4 &transform, float alpha = 1.0) const;
                void draw(const Shader &shader, const V3D &color, float alpha = 1.0) const;
                void draw(const Shader &shader, float alpha = 1.0) const;
